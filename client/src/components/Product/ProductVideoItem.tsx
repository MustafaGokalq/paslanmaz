...
const ProductVideoItem: React.FC<IProps> = ({item}) => {
  return (
    <div className='relative h-[150px] flex flex-col'>
        <div className=' flex h-full  flex-col  w-full border border-black rounded-xl justify-center items-center bg-secondary'>
        ...
        <div className=' w-full flex justify-center items-center'>
            <div className=' border w-3/4 right-10 max-h-[90px] border-black bg-opacity-90 rounded-xl bg-darkSecondary text-white text-sm absolute -bottom-12 flex items-end flex-col'>
                <p>{item.desc}</p>
